...
func assetsAppAppJs() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/app/app.js", size: 3143, mode: os.FileMode(420), modTime: time.Unix(1691557141, 0)}
...
func assetsUiHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/ui.html", size: 5597, mode: os.FileMode(420), modTime: time.Unix(1696394090, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
